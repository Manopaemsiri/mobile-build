...
import '../../../models/partner_product_subscription_model.dart';
...
import 'controllers/subscription_checkout_update_controller.dart';
...
class PartnerProductSubscriptionUpdateCheckoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SubscriptionCheckoutUpdateController>(
      init: SubscriptionCheckoutUpdateController(subscription: subscription, productStep: productStep),
      builder: (controller) {
        ...
        return Scaffold(
          ...
          ? Padding(
            ...
            child: ButtonOrder(
              ...
              title: lController.getLang("Update"),
      ...
      children: [
        ...
        Container(
          ...
          child: CardAddress(
            ...
            onTap: () => Get.to(() => const AddressScreen(subscription: 2)), 
            lController: lController,
          ),
        ),
        const Gap(),
        ...
        Container(
          ...
          child: InkWell(
            onTap: () => Get.to(() => const BillingAddressesScreen(subscription: 2)),
            child: Padding(
              padding: kPadding,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  void onTapShippingMethod(SubscriptionCheckoutUpdateController controllerWidget) {
